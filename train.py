...
parser.add_argument('--learning_rate_initial_step', type=int, default=-1, help='Learning rate initial step for cosine annealing. If < 0, use the counter value from the last snapshot.')
