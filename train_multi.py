...
def main():
    ...
    tflex.trainers_sema = threading.BoundedSemaphore(value=400)
    tflex.trainers_init_sema = threading.BoundedSemaphore(value=400)
    tflex.trainers_load_sema = threading.BoundedSemaphore(value=50)
